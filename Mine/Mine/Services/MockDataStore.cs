    ...
    public class MockDataStore : IDataStore<ItemModel>
    {
        ...
        public bool LoadDefaultData()
        {
            datalist = new List<ItemModel>()
            {
                ...
                new ItemModel { Name = "Red Shell", Description="Auto targets te cart infront", Value = 1 },
                new ItemModel { Name = "Thiple RRed Shell", Description="3 Red Shell.", Value = 3 },
                new ItemModel { Name = "Green Shell", Description="Shoots forward Unguided.", Value=6 },
                new ItemModel { Name = "Lightening Bult", Description="Causes others to shrink.", Value=9 },
            };
